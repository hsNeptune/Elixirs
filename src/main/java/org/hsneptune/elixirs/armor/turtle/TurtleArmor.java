...
public class TurtleArmor {
    ...
    public static final Item TURTLE_CHESTPLATE = ElixirsItems.register("turtle_chestplate", new Item(new Item.Settings().armor(TURTLE, EquipmentType.CHESTPLATE)));
    public static final Item TURTLE_LEGGINGS = ElixirsItems.register("turtle_leggings", new Item(new Item.Settings().armor(TURTLE, EquipmentType.LEGGINGS)));
    public static final Item TURTLE_BOOTS = ElixirsItems.register("turtle_leggings", new Item(new Item.Settings().armor(TURTLE, EquipmentType.BOOTS)));
